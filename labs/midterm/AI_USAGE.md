...
**ชื่อ–นามสกุล:** นรบดี บุญเลิศ **รหัส:** 68543210013-7 **Sec:** 2 **ชุด:** B
...
| เวลา | งาน | Prompt ที่ถาม | AI ตอบว่าอะไร | ฉันทำอะไรต่อ |
|---|---|---|---|---|
| 14:20  | B1.1 | การใช้ .map | แสดงโค้ดตัวอย่างที่เกิด error และวิธีแก้ไข | เปรียบเทียบโค้ดแล้วทำลองแก้ไขในจุดที่สงสัย |
| 15:00 | B1.4 | useEffect ใช้งานยังไง | บอกโครงสร้าง รูปแบบการใช้งาน | เปรียบเทียบโค้ดแล้วทำลองแก้ไขในจุดที่สงสัย |
| 15:15 | B1.5 | การใช้ useMemo | บอก symtax พื้นฐาน, ตัวอย่างใช้งานจริง | เปรียบเทียบโค้ดแล้วทำลองแก้ไขในจุดที่สงสัย |
| 15.25 | B1.6 | การใช้ async await | หลักการทำงาน ตัวอย่างก่อนใช้-หลังใช้ | เปรียบเทียบโค้ดแล้วทำลองแก้ไขในจุดที่สงสัย |
| 16:10  | B2.2 | วิธีการกรอง รายการที่ requestType หรือ location มีข้อความที่พิมพ์ (ไม่สนตัวพิมพ์เล็กใหญ่) react | ตัวอย่างการใช้งาน คำอธิบาย | เปรียบเทียบโค้ดแล้วทำลองแก้ไขในจุดที่สงสัย |
|  |  |  |  |  |
|  |  |  |  |  |
|  |  |  |  |  |
