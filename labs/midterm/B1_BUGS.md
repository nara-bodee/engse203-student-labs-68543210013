...
|---|---|---|---|---|
| 1 | Console เตือนสีเหลืองเรื่องรายการ (list) ที่แผงสรุป | SummaryPanel.jsx:12 | ลืมใส่ prop | ใส่ prop ที่ชื่อว่า key ให้ element ชั้นนอกสุด |
| 2 | ตัวเลข "เสร็จสิ้น" ในแผงสรุปไม่ตรงกับที่เห็นจริง | DashboardPage.jsx:50 | ใส่ status ซ้ำกัน | ใส้ status ให้ถูกต้อง |
